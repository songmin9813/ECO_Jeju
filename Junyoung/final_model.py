...
# 모델링을 하기 위해 train과 test셋을 2018-01부터 2021-06까지로 나눈다
...
x = imp_data.drop(["waste_em_g", "long_visit_pop_cnt", "korean_resd_pop_cnt","korean_work_pop_cnt","disCount","long_resd_pop_cnt","waste_pay_amt","long_work_pop_cnt","mct_cat_nm_6","mct_cat_nm_7","mct_cat_nm_4","mct_cat_nm_1","mct_cat_nm_0","mct_cat_nm_8","mct_cat_nm_9","use_cnt","mct_cat_nm_3","mct_cat_nm_5","mct_cat_nm_10"], axis=1)
x.columns
